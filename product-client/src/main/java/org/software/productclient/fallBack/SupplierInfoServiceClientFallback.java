...
@Slf4j
@Component
public class SupplierInfoServiceClientFallback implements ProductClient.SupplierInfoServiceClient{
    @Override
    public Result<?> save(SupplierInfo supplierInfo) {
        log.info("save callback");
        return null;
    }

    @Override
    public Result<?> update(SupplierInfo supplierInfo) {
